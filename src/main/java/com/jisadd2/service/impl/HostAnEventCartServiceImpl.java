...
@Transactional
public class HostAnEventCartServiceImpl implements HostAnEventCartService {
    ...
    @Autowired
    public HostAnEventCartServiceImpl(ProductRepository productRepository) {
